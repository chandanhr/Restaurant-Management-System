      ...
      okButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            try{
            	...
            	int qu= Integer.parseInt(tf4.getText());
            	
                String q="update food set f_prize="+price+",f_quantity="+qu+" where f_name='"+name+"';";
                int x=Database.insertTable(q);
                
                if(x==1)
                	 JOptionPane.showMessageDialog(null, tf2.getText()+" Updated");
                else
                	 JOptionPane.showMessageDialog(null, "Item not present " + tf2.getText());
